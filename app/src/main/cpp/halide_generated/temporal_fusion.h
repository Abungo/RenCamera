...
int temporal_fusion(struct halide_buffer_t *_input_frames_buffer, struct halide_buffer_t *_motion_fields_buffer, struct halide_buffer_t *_noise_luts_buffer, int32_t _block_size, struct halide_buffer_t *_fused_output_buffer);
